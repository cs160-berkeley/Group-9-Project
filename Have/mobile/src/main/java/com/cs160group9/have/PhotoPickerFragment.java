...
public class PhotoPickerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View photoPickerView = inflater.inflate(R.layout.fragment_photo_picker, container, false);
        final Fragment self = this;
        Button cameraButton = (Button)photoPickerView.findViewById(R.id.camera_btn);
        Button fileButton = (Button)photoPickerView.findViewById(R.id.file_btn);

        cameraButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EasyImage.openCamera(self, 0);
            }
        });
        ...
        fileButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EasyImage.openDocuments(self, 0);
            }
        });
